...
static const int64 MAX_MONEY = 210000000 * COIN; // EVERCOIN: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1.67) / 250; // EVERCOIN: Priority cutoff is 2 EVERCOIN day / 250 bytes.
    }
